...
public class TestACLMessage {
    ...
    public void testJsonInspection() {
        ...
        try {
            String s = InspectMessageHelper.inspect(msg, "$..name[0]");
            assertEquals("x", s);
        } catch (Exception e) {
            e.printStackTrace();
            fail();
    ...
    public void testXpathInspection() {
        ...
        try {
            String s = InspectMessageHelper.inspect(msg,"//name");
            assertEquals("x",s);
        } catch (Exception e) {
            e.printStackTrace();
            fail();
    ...
    public void testMessageConstruction() {
        ...
        Query qry = MessageContentFactory.newQueryContent("test",1,2,3);
        Rule rule = new Rule();
