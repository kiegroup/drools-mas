...
public class ObjectFactory {
    ...
    private final static QName _TellResponse_QNAME = new QName("http://mas.drools.org/", "tellResponse");
    private final static QName _Tell_QNAME = new QName("http://mas.drools.org/", "tell");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mas.drools.org/", name = "tellResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mas.drools.org/", name = "tell")
